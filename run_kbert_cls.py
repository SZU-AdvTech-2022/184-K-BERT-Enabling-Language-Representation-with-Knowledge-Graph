...
def main():
    ...
    parser.add_argument("--train_path", type=str,default='K-BERT-master/datasets/book_review/train.tsv',
                        help="Path of the trainset.")
    parser.add_argument("--dev_path", type=str, default='K-BERT-master/datasets/book_review/dev.tsv',
                        help="Path of the devset.") 
    parser.add_argument("--test_path", type=str,default='K-BERT-master/datasets/book_review/test.tsv',
